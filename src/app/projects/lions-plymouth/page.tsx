    ...
    <>
      ...
      >
        <div className="wrap" style={{ maxWidth: 720 }}>
          ...
          {/* Hero image */}
          <img
            src="/projects/lions-plymouth/Home Page.png"
            alt="Lions Club Plymouth homepage — welcoming community portal with clear navigation"
          ...
          <article className="prose">
            ...
            <img src="/projects/lions-plymouth/Events.png" alt="Events listing page with clear date hierarchy and readable cards" style={{ borderRadius: 8, border: "1px solid var(--rule)" }} />
            ...
            <img src="/projects/lions-plymouth/About Us.png" alt="About Us page with team information and club mission" style={{ borderRadius: 8, border: "1px solid var(--rule)" }} />
            ...
            <img src="/projects/lions-plymouth/Donate.png" alt="Donation page with cause categories and clear call-to-action" style={{ borderRadius: 8, border: "1px solid var(--rule)" }} />
            ...
            <img src="/projects/lions-plymouth/Shop Now Page.png" alt="Shop page with merchandise grid and straightforward cart interaction" style={{ borderRadius: 8, border: "1px solid var(--rule)" }} />
